...
<script>
    ...
    import { tError } from './../../../js/tips'
    import { pAddAddress } from '../../../js/http/param'
    ...
    export default {
        ...
        methods: {
            ...
            addAddress() {
                this.$api.addAddress(this._getReqParam()).then(res => {
                    console.log(res)
                    this.hide()
            ...
            updateAddress() {
                this.$api.updateAddress(this._getReqParam()).then(res => {
                    console.log(res)
                    this.hide()
                    this.bus.$emit('updateAddressList')
                }).catch(err => {
