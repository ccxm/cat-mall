...
<!--                {{tabList[3]}}-->
<!--            </el-tab-pane>-->
<!--            <el-tab-pane :label="tabList[4]" :name="'4'">-->
<!--                {{tabList[4]}}-->
<!--            </el-tab-pane>-->
        </el-tabs>
    </div>
...
<script>
    ...
    import CAddressContainer from '../my-tab-container/c-address-container'
    import COrderItem from './c-order-item'
    import COrderContainer from './c-order-container'
