...
<script>
    ...
    import { pCheckFieldCanUse, pUpdateUserInfo } from './../../../js/http/param'
    ...
    export default {
        ...
        methods: {
            ...
            checkNickNameCanUse(val) {
                ...
                this.$api.checkFieldCanUse(pCheckFieldCanUse).then(res => {
                    console.log(res)
            ...
            updateUserInfo() {
                ...
                this.$api.updateUserInfo(pUpdateUserInfo).then(res => {
                    console.log(res)
