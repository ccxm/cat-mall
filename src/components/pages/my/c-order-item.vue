<template>
    <div class="c-order-item">
        <div class="order-header" :class="orderItem.paymentState === 'SUCCESSED' ? '' : 'order-blue-header'">
        ...
        <div class="order-container" :class="orderItem.paymentState === 'SUCCESSED' ? '' : 'order-blue-container'">
            <el-row class="y-center">
                <el-col :span="16">
                    <div ref="left">
                        <el-row class="y-center goods-item" :class="[{'goods-blue-item': orderItem.paymentState !== 'SUCCESSED'},{'none-bottom-border': index === orderItem.goodsList.length - 1}]"
                ...
                <el-col class="order-right" :span="8">
                    <div ref="right">
                        <el-row class="order-right-row">
                            <el-col class="xy-center order-col-item" :class="orderItem.paymentState === 'SUCCESSED' ? '' : 'order-col-blue-item'" :span="12">
                            ...
                            <el-col class="xy-center order-col-item order-col-item-right" :span="12">
                                <div>
                                    ...
                                    <div v-for="(item, index) in orderItem.goodsList" :key="index">
                                        <div v-if="orderItem.paymentState === 'SUCCESSED'" class="state-item" @click="goToDetail(item.goodsId, 'anchor')">
...
<script>
    ...
    import { pDeleteOrder } from './../../../js/http/param'
    ...
    export default {
        ...
        methods: {
            deleteOrder() {
                ...
                this.$api.deleteOrder(pDeleteOrder).then(res => {
                    this.$emit('del')
                }).catch(err => {
                    console.error(err)
                })
