    ...
    <div class="c-see-more">
        ...
        <div class="mid-side">
            <div :style="changeStyle" class="yx-center">
                ...
                <img v-for="(item, index) in moreGoodsList" :key="index"
                     :src="item.masterImg" @click="goToDetail(item.goodsId)">
            </div>
        </div>
...
<script>
    import {pGetMoreGoods} from './../../../js/http/param'
    ...
    export default {
        ...
        methods: {
            ...
            getMoreGoods(maxLength = 3) {
                ...
                this.$api.getMoreGoods(pGetMoreGoods).then(res => {
                    console.log(res)
