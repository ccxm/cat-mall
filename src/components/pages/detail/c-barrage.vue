<template>
  <div class="c-barrage">
    <c-tag v-for="(item,index) in tempBriefList" :key="index" :detail="item" :goods-id="goodsId" :index="index" @change="onLikeNumChange"/>
...
<script>
    ...
    import { pWriteBrief } from './../../../js/http/param'
    ...
    export default {
        ...
        methods: {
            ...
            writeBrief() {
                this.$api.writeBrief(pWriteBrief).then(res => {
