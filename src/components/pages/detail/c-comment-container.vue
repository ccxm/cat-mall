        ...
        <div class="comment-container">
            ...
            <div class="comment-area">
                <div v-if="commentList.length">
                    <c-comment-item v-for="(item, index) in commentList" :key="index" :comment="item" :goods-id="goodsId" :comment-index="index" :comment-like-list="commentLikeList"/>
                </div>
...
<script>
    ...
    import { pGetBriefList, pGetCommentList, pWriteComment } from './../../../js/http/param'
    ...
    export default {
        ...
        methods: {
            ...
            getBriefList() {
                ...
                this.$api.getBriefList(pGetBriefList).then(res => {
            ...
            getCommentList() {
                ...
                this.$api.getCommentList(pGetCommentList).then(res => {
                    console.log(res)
            ...
            writeComment() {
                ...
                this.$api.writeComment(pWriteComment).then(res => {
                    this.getCommentList()
            ...
            getCommentLikeList() {
                this.$api.getCommentLikeList().then(res => {
