<template>
    <div class="detail">
            ...
            <div class="detail-center">
                <div class="up-side">
                    ...
                    <div class="good-describe y-center">
                        ...
                        <!--            <div class="y-center">-->
                        <!--              <img src="./../../public/images/detail/edit.png">-->
                    ...
                    <div class="post-address y-center__between">
                        <div class="y-center__between">
                            <span>{{goodsDetail.goodsInfo.address}}</span>
                            <span>至</span>
                            <span>北京</span>
                        </div>
                        <span>|</span>
                        <span>运费：{{goodsDetail.goodsInfo.postage}}元</span>
                    </div>
        ...
        <div id="comment">
            <c-comment-container v-if="goodsDetail.goodsInfo" :goods-id="goodsId" :master-img="goodsDetail.goodsInfo.imgList[0]" @num="onTotalCommentNum"/>
        </div>
...
<script>
    ...
    import CDiscount from '../components/pages/cart/c-discount'
    import CInputNumber from './../components/public/c-input-number'
    import CLike from './../components/public/c-like'
    import CImagePicker from './../components/pages/detail/c-image-picker'
    import CSeeMore from './../components/pages/detail/c-see-more'
    // import CCommentModal from './../components/pages/detail/c-comment-modal'
    import CCommentContainer from './../components/pages/detail/c-comment-container'

    import {pGetGoodsDetail, pCreateOrderItem, pAddToCart} from './../js/http/param'
    ...
    export default {
        ...
        methods: {
            getGoodsDetail() {
                this.$api.getGoodsDetail(pGetGoodsDetail).then(res => {
                    console.log(res)
