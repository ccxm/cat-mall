    ...
    <div class="home">
        ...
        <div class="goods-list-container">
            ...
            <div class="goods-list">
                ...
                <div class="good-container" v-if="goodsList.length" :class="(goodsList.length % 3) !== 0 ? 'fill-space' : ''">
...
<script>
    ...
    import CPriceRange from './../components/pages/home/c-price-range'
    import CSortBtn from './../components/pages/home/c-sort-btn'
    import CGoodItem from './../components/pages/home/c-good-item'
    import CPaging from './../components/pages/home/c-paging'
    import { SORT_TYPE } from './../js/const-table'
    import { pGetGoodsList } from './../js/http/param'
    ...
    export default {
        ...
        methods: {
            ...
            getGoodsList(isReset = false) {
                this.$api.getGoodsList(pGetGoodsList).then(res => {
                    console.log(res)
                    this.loading = false
                    this.busy = false
                    if(isReset) {
            ...
            // 获取商品点赞列表
            getGoodsLikeList() {
                this.$api.getGoodsLikeList().then(res => {
                    console.log('点赞列表')
                    console.log(res)
